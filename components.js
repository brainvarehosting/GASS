...
function buildConsultingModal() {
  ...
  document.body.insertAdjacentHTML('beforeend', `
    <a href="mentoring-form.html" class="consult-fab" aria-label="Connect for Consulting">
      ...
      <div class="footer-grid">
        ...
        <div>
          ...
          <nav class="footer-links">
            ...
            <a href="brochure.html" style="color:var(--teal-300);font-weight:700;">&#128065; View Brochure</a>
          </nav>
        </div>
      </div>
  ...
  m.innerHTML = `
    <section style="background:linear-gradient(135deg,var(--navy-900),var(--teal-900));padding:clamp(3rem,6vw,5rem) 1.5rem;text-align:center;">
      ...
      <div style="display:flex;gap:1rem;justify-content:center;flex-wrap:wrap;">
        <a href="mentoring-form.html" class="btn-primary">Connect for Consulting</a>
